...
public class GestaoOrdemServicoService {
	...
	/**
	 * A persistência de comentário foi incluída aqui porque refere-se a um relacionamento de composição.
	 * Um comentário somente pode existir se uma Ordem de serviço existir.
	 */
